  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, i) => (
          <div key={i} className="glass-card flex flex-col gap-4 hover:scale-[1.02] transition-transform">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 glass-card space-y-6">
          ...
          <div className="space-y-4">
            {activities.map((activity, i) => (
              <div key={i} className="flex items-start gap-4 p-4 rounded-2xl hover:bg-white/30 transition-colors">
                <div className="mt-1">
        ...
        {/* Assigned Advisor */}
        <div className="glass-card flex flex-col items-center text-center gap-6 justify-center">
