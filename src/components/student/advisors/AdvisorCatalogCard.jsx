import { CheckCircle2, ChevronDown, FolderOpen, Link2Off, UserPlus } from 'lucide-react';

import { canScheduleRelation, getRelationStatusMeta } from './advisors.utils';
import AdvisorCoursesExplorer from './AdvisorCoursesExplorer';
...
export default function AdvisorCatalogCard({
  ...
  const canBuyCourses = Boolean(relation && canScheduleRelation(relation.estado));
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2 md:justify-end">
          <button
            type="button"
            onClick={() => onToggleCourses?.(advisor)}
      ...
      {isCoursesOpen ? (
        <AdvisorCoursesExplorer
          advisor={advisor}
          coursesState={coursesState}
          buyingCourseId={buyingCourseId}
          canBuyCourses={canBuyCourses}
